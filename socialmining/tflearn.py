...
class TwitterClient(object):
    ...
    def __init__(self, query, retweets_only=False, with_sentiment=False):
        ...
        consumer_key = 'baui93JzNSGkKQytDsYivLSlb'
        consumer_secret = '66cy90H5v3iCWVPYSQkELIAVS1SU8ogNuLmuMRYkk1R7G307vs'
        access_token = '3284166475-tIwgFGIbVjVHMcZxHrJsIlFImWLVtOBD2iTIfkY'
        access_token_secret = 'B5wDTc7ZO6lKzIUKJ5yQmeOd5Jn86b1m1oOKjKf3Jijlb'
    ...
    def get_tweets(self):
        ...
        try:
            ...
            print("Error : " + str(e))
emotive = TwitterClient('#Trump', False, True).get_tweets()
print(emotive)
